...
class GraphTableView(QWidget):
    ...
    def setupActions(self):
        ...
        def add_new_node():
            node_id = self.graphmodel.addNode("new node", "0", "0", "# script")
            ...
            self.nodes_sheet_view.selectRow(new_index.row())
...
if __name__ == "__main__":
    ...
    window.layout().addWidget(graph_view1, 1)
    window.layout().addWidget(graph_view2, 1)
    window.show()
    sys.exit(app.exec())