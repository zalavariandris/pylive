...
class PyGraphModel(QObject):
    ...
    def __init__(self, parent:QObject|None=None):
        ...
        self._nodes_model.modelReset.connect(self.nodesReset.emit)
        self._nodes_model.rowsInserted.connect(self.nodesInserted.emit)
        self._nodes_model.dataChanged.connect(self.nodeChanged.emit)

        self._edges_model = StandardEdgesModel(self._nodes_model)
        self._edges_model.modelReset.connect(self.edgesReset.emit)
        self._edges_model.rowsInserted.connect(self.edgesInserted.emit)
        self._edges_model.dataChanged.connect(self.edgeChanged.emit)
