...
def solve1vp(
        ...
        view_rotation_transform:glmx.mat4 = glmx.mat4_from_mat3(view_orientation_matrix)
...
def compute_orientation_from_single_vanishing_point(
    ...
    Fu_Fv = Fu-Fv
    forward = glmx.normalize(glmx.vec3(Fu_Fv.x, Fu_Fv.y,  -f))
...
def create_axis_assignment_matrix(first_axis: Axis, second_axis: Axis) -> glmx.mat3:
    ...
    axis_aqssignment_matrix = glmx.mat3( # TODO: this is the inverse of the mat3_from_directions
        forward.x,
        forward.y,
        forward.z,
        right.x,
