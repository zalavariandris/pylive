...
def control_point(label:str, point:imgui.ImVec2Like, *, color:imgui.ImVec4|None=None)->Tuple[bool, imgui.ImVec2]:
    if color is None:
        color:imgui.ImVec4 = get_viewer_style().CONTROL_POINT_COLOR
